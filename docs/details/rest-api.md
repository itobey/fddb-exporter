...
::: warning
Both paths are unauthenticated, like the rest of the application, and Swagger UI's "try it out" executes real requests —
including exports. Do not expose them publicly; see [Securing your instance](/details/security.md).
:::
